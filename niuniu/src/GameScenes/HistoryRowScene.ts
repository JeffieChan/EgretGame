module GameScenes {
    export class HistoryRowScene extends egret.DisplayObjectContainer {
        private bg: egret.Shape;
        private scheduleTF: egret.TextField;
        private gameStatusTF: egret.TextField;
        private timeTF: egret.TextField;
        private beanTF: egret.TextField;
        public key: any;
        ...
        public setHistoryData(model: Model.HistoryModel) {
